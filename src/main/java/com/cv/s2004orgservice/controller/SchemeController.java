...
@RestController
@RequestMapping(ORGConstant.APP_NAVIGATION_API_SCHEME)
@AllArgsConstructor
@Slf4j
public class SchemeController implements GenericController<SchemeDto> {

    private SchemeService service;

    @PostMapping
    @Override
    public ResponseEntity<Object> create(@RequestBody @Valid SchemeDto dto, BindingResult result) {
        try {
            if (result.hasErrors()) {
                log.info("SchemeController.create {}", result.getAllErrors());
            ...
            log.error("SchemeController.create {}", ExceptionUtils.getStackTrace(e));
    ...
    @PutMapping
    @Override
    public ResponseEntity<Object> update(@RequestBody @Valid SchemeDto dto, BindingResult result) {
        try {
            if (result.hasErrors()) {
                log.info("SchemeController.update {}", result.getAllErrors());
                return StaticUtil.getFailureResponse(result);
            }
            return StaticUtil.getSuccessResponse(service.update(dto), APIResponseType.OBJECT_ONE);
        } catch (Exception e) {
            log.error("SchemeController.update {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    @Override
    public ResponseEntity<Object> updateStatus(@RequestParam String id, boolean status) {
        try {
            return StaticUtil.getSuccessResponse(service.updateStatus(id, status), APIResponseType.OBJECT_ONE);
        } catch (Exception e) {
            log.error("SchemeController.updateStatus {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> readOne(@RequestParam String id) {
        try {
            log.info("SchemeController.readOne {}", id);
            return StaticUtil.getSuccessResponse(service.readOne(id), APIResponseType.OBJECT_ONE);
        } catch (Exception e) {
            log.error("SchemeController.readOne {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> readPage(@RequestBody PaginationDto dto) {
        try {
            ...
            log.error("SchemeController.readPage {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> readIdNameMapping() {
        try {
            ...
            log.error("SchemeController.readIdNameMapping {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> delete(@RequestParam String id) {
        try {
            ...
            log.error("SchemeController.delete {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
}
