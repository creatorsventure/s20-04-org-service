...
@RestController
@RequestMapping(ORGConstant.APP_NAVIGATION_API_ACTION)
@AllArgsConstructor
@Slf4j
public class ActionController implements GenericController<ActionDto> {
    private ActionService service;

    @PostMapping
    @Override
    public ResponseEntity<Object> create(@RequestBody @Valid ActionDto dto, BindingResult result) {
        try {
            if (result.hasErrors()) {
                log.info("ActionController.create {}", result.getAllErrors());
            ...
            log.error("ActionController.create {}", ExceptionUtils.getStackTrace(e));
    ...
    @PutMapping
    @Override
    public ResponseEntity<Object> update(@RequestBody @Valid ActionDto dto, BindingResult result) {
        try {
            if (result.hasErrors()) {
                log.info("ActionController.update {}", result.getAllErrors());
                return StaticUtil.getFailureResponse(result);
            }
            return StaticUtil.getSuccessResponse(service.update(dto), APIResponseType.OBJECT_ONE);
        } catch (Exception e) {
            log.error("ActionController.update {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> updateStatus(@RequestParam String id, @RequestParam boolean status) {
        try {
            ...
            log.error("ActionController.updateStatus {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> readOne(@RequestParam String id) {
        try {
            log.info("ActionController.readOne {}", id);
            return StaticUtil.getSuccessResponse(service.readOne(id), APIResponseType.OBJECT_ONE);
        } catch (Exception e) {
            log.error("ActionController.readOne {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> readPage(@RequestBody PaginationDto dto) {
        try {
            ...
            log.error("ActionController.readPage {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> readIdNameMapping() {
        try {
            ...
            log.error("ActionController.readIdNameMapping {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> delete(@RequestParam String id) {
        try {
            ...
            log.error("ActionController.delete {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
}
