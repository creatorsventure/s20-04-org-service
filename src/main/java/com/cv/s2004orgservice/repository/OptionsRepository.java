...
@Repository
public interface OptionsRepository extends GenericRepository, GenericSpecification<Options>,
        JpaRepository<Options, String>, JpaSpecificationExecutor<Options> {
}
