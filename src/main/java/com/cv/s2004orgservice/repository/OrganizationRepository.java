...
@Repository
public interface OrganizationRepository extends GenericRepository, GenericSpecification<Organization>,
        JpaRepository<Organization, String>, JpaSpecificationExecutor<Organization> {
}
